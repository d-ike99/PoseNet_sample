...
//        videoInput.ports(for: <#T##AVMediaType?#>, sourceDeviceType: <#T##AVCaptureDevice.DeviceType?#>, sourceDevicePosition: <#T##AVCaptureDevice.Position#>)
